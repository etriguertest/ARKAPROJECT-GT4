...
public class SqsTransformer {
     ...
     */
    public Flux<InventoryTransaction> convertJsonStringToFlux(String jsonString) {

        // 1. Define the target type: a List of your DTO.
        TypeReference<List<InventoryTransaction>> listType =
                new TypeReference<>() {};
        try {
            // 2. Deserialize the JSON string into the List.
            List<InventoryTransaction> dtoList =
     ...
     */
    public Mono<String> listToString(java.util.List<InventoryMovementRequestDto> dtoList) {
        return Mono.fromCallable(() -> {
            try {
