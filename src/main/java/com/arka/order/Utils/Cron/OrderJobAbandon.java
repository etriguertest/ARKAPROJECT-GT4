package com.arka.order.Utils.Cron;
...
import com.arka.order.Service.MessageProducerService;
...
@Slf4j
@Component
public class OrderJobAbandon {
    private final OrderRepository orderRepository;
    private final MessageProducerService messageProducerService;
    private WebClient webClient;

    public OrderJobAbandon(OrderRepository orderRepository, MessageProducerService messageProducerService){
